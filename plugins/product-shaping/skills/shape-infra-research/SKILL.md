...
description: >
  ...
  Use AFTER /shape-prd or /shape-tech-stack.
...
- `/shape-prd` — upstream. Produces `context/foundation/prd.md` with product context. Optional input.
- `/shape-tech-stack` — upstream. Produces `context/foundation/tech-stack.md`. The primary hard-constraint input — load it if present.
- `/shape-stack-assess` — sibling. Assesses the existing stack for agent-friendliness. Infrastructure research is the deployment complement.
...
1. **If a path argument was provided** (e.g. `/shape-infra-research @context/foundation/tech-stack.md`), strip a leading `@` if present and use the path as the tech-stack location for this run.
...
```bash
test -f "$CONTEXT_ROOT/context/foundation/infrastructure.md"
```
...
═══════════════════════════════════════════════════════════
  ...
  ► Next:        Implement deployment per the platform's quickstart.
═══════════════════════════════════════════════════════════
```

STOP. The user takes the platform's documented quickstart from here.
